...
(() => {
  function fixImages(): void {
    const imageElements = document.querySelectorAll('img:has(+a)') as NodeListOf<HTMLImageElement>

    for (const imageElement of imageElements) {
      const clickableElement = imageElement.nextElementSibling as HTMLElement
