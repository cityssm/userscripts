...
;(() => {
  ...
  if (
    searchParameters.has('directChargeID') &&
    !referrer.includes(
      `directChargeID=${searchParameters.get('directChargeID')}`
    )
  ) {
    ...
    searchParameters.has('id') &&
    !referrer.includes(
      `directChargeID=${searchParameters.get('id')}`
    )
  ) {
    ...
    searchParameters.has('workOrderID') &&
