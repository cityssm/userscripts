...
(() => {
    ...
    for (const elementSelectorWithHeight of elementSelectorsWithHeight) {
        const heightElement = document.querySelector(elementSelectorWithHeight);
     ...
     */
    const emptyPaddingElement = document.querySelector('#ctl00_RadPane_Content .workOrderHeader');
    if (emptyPaddingElement !== null &&
        ((_a = emptyPaddingElement.textContent) !== null && _a !== void 0 ? _a : '').trim() === '') {
        emptyPaddingElement.remove();
    }
    /*
     * Ensure padding is consistent.
     */
    const cellPaddingElement = (_b = document.querySelector('#ctl00_ContentPlaceHolder_Content_DetailMenu_WorkOrderDetailMenuPanel')) === null || _b === void 0 ? void 0 : _b.parentElement;
