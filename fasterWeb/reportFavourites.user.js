...
(() => {
    ...
    const favourteReportsArray = JSON.parse(GM_getValue(favouriteReportsStorageKey, '[]'));
    const favouriteReports = new Set(favourteReportsArray);
    /*
     * Toggle function
     */
    function toggleFavourite(clickEvent) {
        var _a;
        clickEvent.preventDefault();
        const toggleElement = clickEvent.currentTarget;
        const reportName = (_a = toggleElement.dataset.reportName) !== null && _a !== void 0 ? _a : '';
