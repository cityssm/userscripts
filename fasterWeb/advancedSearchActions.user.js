...
(() => {
    ...
    if (lowerCasePathName.includes('/domains/assets/')) {
        (_a = document
            .querySelector('#ctl00_Navigation_RadMenuActions ul')) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
        ...
        (_b = document
            .querySelector('#ctl00_Navigation_RadMenuInventoryActions ul')) === null || _b === void 0 ? void 0 : _b.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
        ...
        (_c = document
            .querySelector('#ctl00_Navigation_RadMenuActions ul')) === null || _c === void 0 ? void 0 : _c.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
        ...
        (_d = document
            .querySelector('#ctl00_Navigation_RadMenuActions ul')) === null || _d === void 0 ? void 0 : _d.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
        ...
        (_e = document
            .querySelector('#ctl00_Navigation_RadMenuActions ul')) === null || _e === void 0 ? void 0 : _e.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
        ...
        (_f = document
            .querySelector('#ctl00_Navigation_RadMenuActions ul')) === null || _f === void 0 ? void 0 : _f.insertAdjacentHTML('afterbegin', `<li style="width:100%;" class="rmItem ${liClassName}">
    ...
    const actionElements = document.querySelectorAll(`.${liClassName}`);
